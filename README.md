...
- **이혜연**:
- **정찬빈**:
- **황정연**: B+Tree가 탐색속도를 줄여준다는 막연하게 알고 있었습니다. 그러나 코드를 하나하나 풀어나가면서, tree가 확장해 나가고 포인터로 배선이 수정되는지 더 깊은 이해를 통해 지식을 쌓는 소중한 경험을 했습니다.

- **통합**:
>>>>>>> 759a219e03d4cd440dfb2214c64cf41f0c934dc6
